...
I’m a Master’s student in Informatics and Computing Engineering at [FEUP](https://www.up.pt/feup/pt/), and a Research Assistant at [INESC TEC’s](https://www.inesctec.pt/pt) Telecommunications and Multimedia Center.
...
### 🛠️ Technical Stack
**Languages:** Python, Java, C/C++, JavaScript/TypeScript, (Assembly, PROLOG, Haskell)
- **Web Development:** Node.js, NestJS, React.js, GraphQL, Laravel, FastAPI
- **Data Science & ML:** Scikit-learn, Surprise, Jupyter, Pandas/NumPy
- **Cloud & DevOps:** Google Cloud, Docker, Terraform
- **Multimedia & Graphics:** Three.js, OpenCV
- **Tools:** Git, LaTeX, Figma, Maze
...
| [**O**](https://github.com/oManuelmo/Y4S2_Optimization) | Hardware Procurement | CPLEX | 19.0 |
